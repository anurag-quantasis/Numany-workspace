...
import { ScheduleSelectorComponent } from 'projects/main-numany/src/app/shared/components/schedule-selector/schedule-selector.component';
import { ScheduleSelection } from 'projects/main-numany/src/app/shared/components/schedule-selector/schedule-selector.model';

@Component({
  selector: 'tenant-administration-schedules',
  standalone: true,
