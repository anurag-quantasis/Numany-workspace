...
@Component({
  ...
  imports: [SharedPanelContainerComponent, CustomInputComponent, CommonModule,
    ReactiveFormsModule,
    FieldsetModule,
    CheckboxModule,
    RadioButtonModule, Button],
...
export class SiteParametersComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.siteParametersForm = this.fb.group({
      ...
      ucoInterval: [0, [Validators.required, Validators.maxLength(2), Validators.pattern(/^[0-9]*$/)]],
