  ...
  ngOnInit() {
    this.items = [
      // UCO List
      {
        ...
        shortcut: undefined,
        command: () => { console.log("Helloooo from first") },
        items: [
          {
        ...
        items: [
          {
            ...
            shortcutLabel: 'A',
            shortcutHint: 'A',
            command: () => { console.log('Active Order Profile clicked'); },
          },
          {
            label: 'Census',
            shortcut: 'alt.r c',
            shortcutHint: 'C',
            command: () => { console.log('Census clicked'); },
          },
          {
            label: 'Dispensing Transaction Reports',
            shortcut: 'alt.r d',
            shortcutHint: 'D',
            command: () => { console.log('Dispensing Transaction Reports clicked'); },
          },
          {
            label: 'Med Fill',
            ...
            shortcutHint: 'M',
            command: () => { console.log('Med Fill clicked'); },
          },
          {
            label: 'IV Fill',
            shortcut: 'ctrl.i',
            ...
            shortcutHint: 'I',
            command: () => { console.log('IV Fill clicked'); },
          },
          {
            label: 'Financial',
            shortcut: 'alt.r f',
            ...
            items: [
              {
                ...
                shortcutLabel: 'D',
                shortcutHint: 'd',
                command: () => { console.log('Daily Charges'); },
              },
              {
                ...
                shortcutLabel: 'F',
                shortcutHint: 'f',
                command: () => { console.log('Formulary Repricing'); },
              },
              {
                ...
                shortcutLabel: 'W',
                shortcutHint: 'w',
                command: () => { console.log('Ward Cost Summary'); },
              },
              {
                ...
                shortcutLabel: 'M',
                shortcutHint: 'm',
                command: () => { console.log('Financial Modeling Report'); },
              },
              {
                ...
                shortcutLabel: 'S',
                shortcutHint: 's',
                command: () => { console.log('Submit TP Building'); },
              },
            ],
          },
          {
            ...
            shortcutHint: 'M',
            items: [ /* Add management sub-items here */],
          },
          {
            label: 'MAR',
        ...
        items: [
          {
            ...
            shortcutLabel: 'B',
            shortcutHint: 'B',
            command: () => { console.log('Batch Charge Adjustments clicked'); },
          },
          {
            ...
            shortcutHint: 'S',
            command: () => { console.log('Floor Stock Charging clicked'); },
          },
          {
            ...
            shortcutLabel: 'F2',
            shortcutHint: 'F2',
            command: () => { console.log('Interdept Transfers clicked'); },
          },
          {
            ...
            shortcutLabel: 'U',
            shortcutHint: 'U',
            command: () => { console.log('Update Med OE Fill Thru Date/Time clicked'); },
          },
          {
            ...
            shortcutLabel: 'Z',
            shortcutHint: 'Z',
            command: () => { console.log('Zero Units Charged on TEST Patients clicked'); },
          },
        ],
      },
      // Files
        ...
        items: [
          {
            ...
            shortcut: 'alt.f a',
            shortcutHint: 'A',
            command: () => { console.log('Administration Schedules clicked'); },
          },
          {
            label: 'Bed/Ward',
            shortcut: 'alt.f b',
          ...
          },
          {
            ...
            shortcut: 'alt.f c',
            shortcutHint: 'C',
            command: () => { console.log('Charge Algorithm clicked'); },
          },
          {
            label: 'Department Names',
            command: () => { console.log('Department Names clicked'); },
          },
          {
            label: 'Drug',
            shortcut: 'alt.f d',
            shortcutHint: 'd',
            command: () => { console.log('Drug clicked'); },
            items: [],
          },
          {
            ...
            shortcut: 'alt.f f',
            shortcutHint: 'F',
            command: () => { console.log('Financial Reporting Groups clicked'); },
          },
          {
            label: 'Patient/Payor Type',
            // shortcut: 'alt.f p',
            // shortcutHint: 'P',
            command: () => { console.log('Patient/Payor Type clicked'); },
          },
          {
          ...
          },
          {
            ...
            shortcut: 'f8',
            shortcutLabel: 'F8',
            command: () => { console.log('Printer/Report Selection clicked'); },
          },
          {
            label: 'Route Codes',
            shortcut: 'alt.f r',
          ...
          },
          {
            ...
            // shortcut: 'alt.f s',
            // shortcutHint: 'S',
            command: () => { console.log('Sig Codes clicked'); },
          },
          {
            label: 'Sig Parts',
            // shortcut: 'alt.f t',
            // shortcutHint: 'T',
            command: () => { console.log('Sig Parts clicked'); },
          },
          {
            label: 'Site Parameters',
            shortcut: 'alt.f t',
            shortcutHint: 't',
            command: () => { console.log('SiteParameters clicked'); },
          },
          {
            label: 'Standing Orders',
            shortcut: 'alt.f s',
            shortcutHint: 's',
            command: () => { console.log('Standing Orders clicked'); },
          },
          {
          ...
          },
          {
            ...
            shortcut: 'alt.f w',
            shortcutHint: 'w',
            command: () => { console.log('Ward/Bed Area Cost Centers'); },
          },
          {
          ...
          },
          {
            ...
            // shortcut: 'alt.f e',
            // shortcutHint: 'E',
            command: () => { console.log('Export Patients and Active Orders clicked'); },
          },
          {
          ...
          },
          {
            ...
            // shortcut: 'alt.f i',
            // shortcutHint: 'I',
            command: () => { console.log('Import Diagnosis File Update clicked'); },
          },
          {
            label: 'Alert File Matrix',
            shortcut: 'alt.f x',
            shortcutHint: 'x',
            command: () => { console.log('Alert File Matrix clicked'); },
          },
          {
          ...
          },
          {
            ...
            shortcut: 'alt.f t',
            shortcutHint: 'T',
            command: () => { console.log('Third Party Provider Data clicked'); },
          ...
          },
          {
            ...
            // shortcut: '',
            shortcutHint: 'B',
            command: () => { console.log('Backup Current Database clicked'); },
          },
          {
            label: 'Restore Database',
            shortcut: 'alt.f s',
            shortcutHint: 'S',
            command: () => { console.log('Restore Database clicked'); },
          ...
          },
          {
            ...
            shortcut: 'alt.f d',
            shortcutHint: 'D',
            command: () => { console.log('Print/Display Data Dictionary clicked'); },
            disabled: true, // Grayed out
          },
          {
            ...
            shortcut: 'alt.f m',
            shortcutHint: 'M',
            command: () => { console.log('Merge Patients clicked'); },
          },
          {
            label: 'Initialize/Update Next Dose Time for EMAR',
            shortcut: 'alt.f n',
            shortcutHint: 'N',
            command: () => { console.log('Initialize/Update Next Dose Time for EMAR clicked'); },
          }
        ]
      }
