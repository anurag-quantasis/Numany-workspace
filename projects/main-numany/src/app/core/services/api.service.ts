...
export class ApiService {
   ...
   */
  put<T>(endpoint: string, body: any, options?: { params?: HttpParams, headers?: HttpHeaders }): Observable<T> {
   ...
   */
  patch<T>(endpoint: string, body: any, options?: { params?: HttpParams, headers?: HttpHeaders }): Observable<T> {
